...
public class Fragment_Map extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_fragment_map, container, false);
        mapView = rootView.findViewById(R.id.mapview_map);
        ...
        BitmapDescriptor bitmap = BitmapDescriptorFactory.fromResource(R.drawable.jnuicon);
                    ...
                    if(null!=content) {
                        try {
                            ...
                            for(int index=0;index<shops.length();index++)
                            {
                                ...
                                OverlayOptions textOption = new TextOptions().bgColor(0xAAFFFF00).fontSize(25)
